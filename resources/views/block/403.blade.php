        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-5 col-8">
                    <div class="text-center">
                        ...
                        <div>
                            <img src="{{ asset('assets/images/403.png') }}" alt="" class="img-fluid" />
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <p class="text-muted mb-4">You do not have permission to access this page.<br />Please contact the
                        administrator if you believe this is a mistake.</p>
